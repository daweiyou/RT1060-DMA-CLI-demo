...
#define RTOS_LPUART_TX_COMPLETE 0x1
...
#define RTOS_LPUART_HARDWARE_NOISE_ERROR (1<<3)
#define RTOS_LPUART_HARDWARE_FRAME_ERROR (1<<4)
#define RTOS_LPUART_HARDWARE_PARITY_ERROR (1<<5)
#define RTOS_LPUART_RX_COMPLETE (1<<6)
